      ...
      <div class="container mx-auto px-4">
        ...
        <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
            ...
            <div class="lg:flex lg:items-start">
              <div class="lg:order-2 lg:ml-5">
                <div class="max-w-xl overflow-hidden rounded-lg">
                  <img class="h-full w-full max-w-full object-cover" src="https://th.bing.com/th/id/OIP.gy5ir7_Nb5DvWgr8IAbDtgHaFb?w=250&h=184&c=7&r=0&o=5&pid=1.7" alt="" />
                </div>
              </div>
              ...
              <!-- <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                <div class="flex flex-row items-start lg:flex-col">
                  <button type="button"
                    ...
                    <img class="h-full w-full object-cover" src="https://th.bing.com/th/id/OIP.gy5ir7_Nb5DvWgr8IAbDtgHaFb?w=250&h=184&c=7&r=0&o=5&pid=1.7" alt="" />
                  </button>
                  <button type="button"
          ...
          <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <!-- <h2 class="mt-8 text-base text-gray-900">Pilihan Seri</h2>
            ...
            <h2 class="mt-8 text-base font-bold text-gray-900">Pilihan Warna</h2>
            <div class="mt-3 flex select-none flex-wrap items-center gap-1">
              <label class="">
                <input type="radio" name="subscription" value="Biru" class="peer sr-only" />
                <p
                  class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">
                 Biru</p>
                <span class="mt-1 block text-center text-xs"></span>
              </label>
              <label class="">
          ...
          <div class="lg:col-span-3">
            ...
            <div class="mt-8 flow-root sm:mt-12">
              <h1 class="text-3xl font-bold">Sepeda BMX Polygon Blizzard</h1>
              <p class="mt-4">Meski murah, sepeda BMX Polygon Blizzard tampil elegan. Cocok bagi kalian suka freestyle atau atraksi dengan sepeda BMX. Desain sepeda BMX Polygon Blizzard cukup standar, mirip dengan sepeda BMX pada umumnya. Mengutip dari situs resmi Polygon Indonesia, frame sepeda BMX Polygon Blizzard menggunakan material alumunium.</p>
