  ...
  <div>
    ...
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      <div class="rounded-lg md:w-2/3">
        <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start" v-for="cart in getCart" :key="cart.id">
          <img src="https://th.bing.com/th/id/OIP.lPqTSiCf_X7NVTrIAFNSJgHaEK?w=256&h=180&c=7&r=0&o=5&pid=1.7" alt="product-image" class="w-full rounded-lg sm:w-40" />
          <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div class="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              ...
              <div class="flex items-center space-x-4">
                ...
                <button @click="removeItem(cart.cart_id)">
      ...
      <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
        ...
        <!-- <div class="flex justify-between">
          ...
          <p class="text-gray-700">{{ getAddress }}</p>
        </div> -->
        <hr class="my-4" />
        <div class="flex justify-between">
